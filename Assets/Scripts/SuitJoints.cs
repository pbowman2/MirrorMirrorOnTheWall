...
public class SuitJoints : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        foreach (var body in bodies)
        {
            ...
            if (body.IsTracked)
            {
                ...
                var posMid = body.Joints[JointType.SpineBase].Position;
                ...
                gameObject.transform.position = new Vector3((posMid.X * mult) + 5, (posMid.Y * mult)-40, 90F);
                ...
                multiplier = (float)System.Math.Sqrt((xSqaure + ySqaure + zSqaure))*125;
